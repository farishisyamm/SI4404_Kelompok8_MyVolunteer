...
class EventsSeeder extends Seeder
{
    ...
    public function run()
    {
        $events= [
            ...
            ['user_id' => '9', 'event_name' => 'Pembuatan Taman Kota', 'event_location' => 'Bali', 'longitude' => '115.216667', 'latitude' => '-8.650000', 'start_date' => '2022-05-15 08:00:00', 'end_date' => '2022-05-15 15:00:00', 'resource_need' => '100', 'event_description' => ' Kami mengadakan acara pembuatan taman kota di Bali untuk menambah ruang hijau di kota tersebut. Kami membutuhkan relawan yang bisa membantu kami membuat taman tersebut.', 'event_status' => 'S', 'reward' => 'Sertifikat penghargaan dan makan siang gratis'],
            ['user_id' => '9', 'event_name' => 'Festival Seni Budaya', 'event_location' => 'Surabaya', 'longitude' => '112.750000', 'latitude' => '-7.333333', 'start_date' => '2022-07-10 09:00:00', 'end_date' => '2022-07-10 16:00:00', 'resource_need' => '75', 'event_description' => 'Kami mengadakan festival seni budaya di Surabaya untuk mengenalkan kebudayaan Indonesia kepada masyarakat. Kami membutuhkan relawan yang bisa membantu kami mengatur acara tersebut.', 'event_status' => 'S', 'reward' => 'Sertifikat penghargaan dan hadiah menarik bagi relawan terbaik'],
            ...
            ['user_id' => '10', 'event_name' => 'Pembuatan Jalan Sepeda', 'event_location' => 'Yogyakarta', 'longitude' => '110.366547', 'latitude' => '-7.807380', 'start_date' => '2022-11-20 09:00:00', 'end_date' => '2022-11-20 15:00:00', 'resource_need' => '75', 'event_description' => 'Kami mengadakan baksos pendidikan di Bandung untuk membantu anak-anak yang kurang mampu untuk mendapatkan pendidikan yang berkualitas. Kami membutuhkan relawan yang bisa membantu kami mengatur acara tersebut.', 'event_status' => 'S', 'reward' => 'Sertifikat penghargaan'],
        ];
