    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center mx-auto">
                ...
                <p data-aos="fade-up" class=" mb-5 text-white lead text-white-50">There are still many people who need our help in this country</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="causes-item bg-white">
                    ...
                    <div class="px-4 pb-5 pt-3">
                        ...
                        <p>According to data from the Global Hunger Index for 2021, the hunger rate in Indonesia is still at level 18, the third highest in Southeast Asia after Timor Leste and Kaos. Meanwhile, according to the Central Statistics Agency there are 17 million people or 6.1 percent of Indonesia's population still experiencing hunger.</p>
