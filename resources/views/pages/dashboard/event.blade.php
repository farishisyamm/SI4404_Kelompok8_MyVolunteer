...
@section('content')
<div class="row">
    <a href="{{url('/addevent')}}" class="text-lg-end text-body text-sm font-weight-bold mb-2 icon-move-right mt-auto p-4">Tambah Kegiatan <i class="fas fa-plus text-sm ms-1" aria-hidden="true"></i></a>
    <div class="col-12">
        <div class="card mb-4">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <a class="btn btn-link text-dark px-3 mb-0" href="<?php echo url('/edit');?>"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2">
                                        <div>
                                            <img src="images/small-logos/logo-webdev.svg"
