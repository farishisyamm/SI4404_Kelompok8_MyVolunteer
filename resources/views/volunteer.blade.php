...
<body>
    ...
    <div class="hero overlay" style="background-image: url('images/bg-rebouisasi.jpg')">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center mx-auto">
                    ...
                    <p data-aos="fade-up" class=" mb-5 text-white lead text-white-50">Ikutilah kegiatan yang dapat
                        membantu masyarakat secara bersama sama.</p>
                    <p data-aos="fade-up" data-aos-delay="100">
                        <a href="#cause" class="btn btn-primary me-4">Apply Now</a>
                    </p>
    ...
    <div class="section cause-section bg-light" id="cause">

        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="100">
                    <span class="subheading mb-3">Kegiatan</span>
                    <h2 class="heading">Kegiatan Terbaru</h2>
                ...
                <div class="features-slider" id="features-slider">
                    ...
                    <div class="item">
                        <div class="causes-item bg-white">
                            <a href="#"><img src="images/imunisasibayi.jpeg" alt="Image"
                                    class="img-fluid mb-4 rounded"></a>
                            <div class="px-4 pb-5 pt-3">

                                <h3><a href="#">Imunisasi Dasar Lengkap pada Bayi</a></h3>
                                <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                        <path
                                            d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                                    </svg> Malang, Jawa Timur</p>
                                ...
                                <div class="d-flex mb-4 justify-content-between amount">
                                    <div>25 terisi </div>
                                    <div>100 Volunteer</div>
                                </div>
                                <div>
                                    <a href="#" class="btn btn-primary">Apply As Volunteer</a>
                                </div>
                            </div>
                        </div>
                    </div>
